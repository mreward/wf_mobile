export default {
    ...
    m_cake_designer_add_lettering_message: 'Inscription',
    m_cake_designer_add_lettering_message_text: 'Enter text, max. 30 characters',
    ...
    m_cake_designer_button_title: 'Cake constructor',
    ...
    m_cake_designer_not_found_decors: 'Design options not found',
    m_cake_designer_not_found_fillings: 'No filling options found',
    m_cake_designer_not_found_letterings: 'Label variants not found',
    m_cake_designer_price: 'The cost',
    m_cake_designer_select: 'Choose',
    m_cake_designer_select_from_catalog: 'Choose from catalog',
    m_cake_designer_send_feedback: 'Send request',
